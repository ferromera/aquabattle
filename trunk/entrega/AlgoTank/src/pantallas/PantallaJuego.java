...
public class PantallaJuego extends Pantalla implements SerializableXML {
	private static final String RUTA_NIVEL_1 = "./niveles/nivel1.xml";
	...
	private static final String RUTA_NIVEL_2 = "./niveles/nivel2.xml";
	...
	public PantallaJuego() {
		...
		niveles.add(new Nivel(2, RUTA_NIVEL_2, 1000));
	...
	private void siguienteNivel() {
		if(nivelActual==niveles.size()-1)		
			...
			nivelActual++;
			Escenario.nuevaInstancia();
			VistaPantallaJuego.getInstancia().reiniciarEscenario();
